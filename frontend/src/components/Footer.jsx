        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <img src="/logo192.png" alt="Swap My Face Tees" className="w-10 h-10 rounded-full object-cover flex-shrink-0" />
              <img src="/logo_text.png" alt="Swap My Face Tees" className="h-6 object-contain" style={{ maxWidth: '130px', filter: 'brightness(10)' }} />
            </Link>
