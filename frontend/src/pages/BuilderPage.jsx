...
const HeadImage = ({ imageUrl, placement, isSelected, onSelect, onChange, brightness, contrast }) => {
  ...
  // Position top-left corner so image is centred on placement point
  ...
  return (
    <>
      <KonvaImage
        ...
        onClick={onSelect} onTap={onSelect}
        onDragEnd={(e) => {
          // Convert top-left position back to centre-based placement
          onChange({
...
export default function BuilderPage() {
  ...
  // Measure container width and set scale so Stage fits perfectly
  useEffect(() => {
    const measure = () => {
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div
                ...
                style={{ background: currentShirtColor.hex, touchAction:'none', transition:'background 0.2s', height: CANVAS_HEIGHT * canvasScale }}
              >
                <Stage
                  ref={stageRef}
                  width={CANVAS_WIDTH}
