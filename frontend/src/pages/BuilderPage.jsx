...
const HeadImage = ({ imageUrl, placement, isSelected, onSelect, onChange, brightness, contrast }) => {
  ...
  // Apply brightness/contrast filters whenever they change
  useEffect(() => {
    if (shapeRef.current) {
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="mt-4 p-4 bg-[#FFF9E6] border border-[#FFE600] rounded-xl space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs font-bold text-[#1C1C1C] tracking-wide uppercase">Before we print — we check every order</p>
                </div>
                <ul className="text-xs text-gray-700 space-y-1 pl-8 list-disc">
                  <li>Every order is manually reviewed before printing</li>
                  <li>A <strong>digital proof</strong> will be sent to you for approval first</li>
                  <li>We will contact you if we need a better quality photo</li>
