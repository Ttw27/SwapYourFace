  ...
  useEffect(() => {
    ...
    const measure = () => {
      if (canvasContainerRef.current) {
        ...
        if (w > 10) setCanvasDisplayWidth(Math.min(CANVAS_WIDTH, w));
      }
    };
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              {/* Canvas — fixed 400x500, scaled to fit via CSS transform */}
              <div
              ...
              >
                <Stage
                  ref={stageRef}
                  width={canvasDisplayWidth || CANVAS_WIDTH}
                  height={(canvasDisplayWidth || CANVAS_WIDTH) * CANVAS_HEIGHT / CANVAS_WIDTH}
                  scaleX={(canvasDisplayWidth || CANVAS_WIDTH) / CANVAS_WIDTH}
                  scaleY={(canvasDisplayWidth || CANVAS_WIDTH) / CANVAS_WIDTH}
