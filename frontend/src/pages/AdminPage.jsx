                    ...
                    <div key={i} className="bg-gray-50 rounded-xl p-4">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          {item.titleText && <p className="text-sm text-gray-500">Title: "{item.titleText}"</p>}
                          {item.subtitleText && <p className="text-sm text-gray-500">Subtitle: "{item.subtitleText}"</p>}
                      ...
                      {item.headUrl && (
                        <div className="mt-3 flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <a href={`${process.env.REACT_APP_BACKEND_URL}${item.headUrl}`} target="_blank" rel="noreferrer" className="text-xs text-[#FF2E63] font-medium">Download image</a>
                          </div>
                        </div>
                      )}
                    </div>
